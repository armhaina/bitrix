...
✊ Образы для быстрого прототипирования актуальной версии [1C-Bitrix: Управление сайтом (БУС)][1] под соответствующую версию PHP.

## 🚀 Старт

Вы можете перейти в директорию [example-app](example-app), где подробно изложено как правильно и быстро запустить свой проект на 1C-Bitrix (БУС).
