...
После успешной сбоорки проекта можете перейти на страницу `http://APP_HOST` (заменить [**APP_HOST**](#APP_HOST) на хост из `.env` файла). Вы должны увидеть [стартовую страницу установки](attachment/images/1-page-start.png) `БУС`.

1. На странице [Регистрация продукта](attachment/images/2-page-product-registration.png) снимите галочку с пункта `Я хочу зарегистрировать свою копию продукта, устанавливать решения из Маркетплейс и получать обновления`.
